      ...
      <section className={`footer ${style_2 ? 'fstyle-2' : ''}`}>
        <div className="container">
          ...
          <div className="row footer-bottom">
              ...
              <div className="single-footer">
                <div className="about-footer">
                  <div className="footer-logo">
                    <a href="#"><img src="/logo.png" style={{width : '50px'}} alt="Edumon" /> Sleeping Survey</a>
                  </div>
                  <p>
                  Comprehensive Sleep Research Seeks Participant Insights Now
                  </p>
            ...
            <div className="col-xl-3 col-md-6 col-12 wow fadeIn">
              <div className="single-footer">
                <h3 className="footer-title">Activities</h3>
                <ul>
                  <li><a href="#">Participant Recuriment</a></li>
                  <li><a href="#">Data Collection</a></li>
                  <li><a href="#">Survey Design</a></li>
                  <li><a href="#">Consent Process</a></li>
        ...
        <div className="copyright text-center wow fadeIn">
          <p>Copyright © {new Date().getFullYear()} <a href="#">Sleeping</a>. All rights reserved.</p>
        </div>
      </section>
    </>
  )
