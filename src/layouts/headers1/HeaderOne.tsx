...
export default function HeaderOne(homeRefFun:any, aboutRefFun:any, dreamRefFun:any, statisticsRefFun:any, contactRefFun:any) {
  ...
  return (
    <>
      <header id="navigation">
            ...
            <div className="col-30 left-col align-self-center rk_style">
              ...
              <div className="course_cat">
                <ul className="cat_list">
                  <li><a href="#"><i className="bx bx-grid-alt"></i> Category</a>
                    <ul className="sub-menu">
                      <li><a href="#" onClick={homeRefFun}>Web Design</a></li>
                      <li><a href="#" onClick={aboutRefFun}>Fitness</a></li>
                      <li><a href="#" onClick={dreamRefFun}>WordPress</a></li>
                      <li><a href="#" onClick={statisticsRefFun}>React</a></li>
                      <li><a href="#" onClick={contactRefFun}>Shopify</a></li>
                      <li><a href="#">Java</a></li>
                      <li><a href="#">PHP</a></li>
                    </ul>
                  </li>
        ...
        <div id="sm_menu_ham" className={`${openMenu ? "open" : ""}`} onClick={() => setOpenMenu(!openMenu)}><span></span><span></span><span></span><span></span></div>
