...
interface HeroHomeOneSliderProps {
    data: any;
    setShowModal: any;
}

const HeroHomeOneSlider = ({data, setShowModal}:HeroHomeOneSliderProps) => {
                  ...
                  <span className="subtitle">Sleeping Survey Support</span>
                    <div className='heroSlickContainer'>
                      <div className='heroSlick'>
                          <h2 className="title"><span>{data.titleEmphasize}</span> {data.titleContent}</h2>
                          <p>
                            {data.content}
                          </p>
                      </div>
